...
describe "Test Stack Implementation" do
  ...
  it "starts the size of a Stack at 0" do
    # skip
    s = Stack.new
    # this test wont run cause the array is nil and it wont do anything on nil and wont return an error...
    s.size.must_equal 0
    s.empty?.must_equal true
    # can't combine testing conditionals like this
    # s.size.must_equal 0 && s.empty?.must_equal true
  end
